# -*- coding: utf-8 -*-
"""
Created on Tue Jan 18 14:11:10 2022
...
X_train_ss = X_train[0:int(0.5*len(X_train))]
y_train_ss = y_train[0:int(0.5*len(y_train))]
...
# Create a pipeline
#pipeline = make_pipeline(
#    NearMiss(version=3), RandomForestClassifier())

# Create a pipeline
pipeline = make_pipeline(
    NearMiss(version=3), DecisionTreeClassifier())
